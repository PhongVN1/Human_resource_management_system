...
def expand_key(key, rounds):
    ...
    key_grid = break_in_grids_of_16(key)
    if key_grid:  # Check if the list is not empty
        key_grid = key_grid[0]
...
def sha256_hash_string(input_string):
    ...
    return hash_value
#nhap pass -> hash 256 -> kiem tra pass (<16) / kiem tra
#nhap pass moi -> hash 256 ->luu pass / tao mat khau
#nhap pass cu -> hash 256 -> kiem tra pass ->(dung)nhap pass moi -> hash 256 ->luu pass / doi mat khau